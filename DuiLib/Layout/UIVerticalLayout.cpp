...
std::shared_ptr<CControlUI> CVerticalLayoutUI::GetInterface(faw::string_t pstrName)
{
    if(pstrName == DUI_CTRL_VERTICALLAYOUT) return std::dynamic_pointer_cast<CVerticalLayoutUI>(shared_from_this());
