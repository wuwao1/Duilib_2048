...
std::shared_ptr<CControlUI> CIPAddressExUI::GetInterface(faw::string_t pstrName)
{
    if(pstrName == DUI_CTRL_IPADDRESS)return std::dynamic_pointer_cast<CIPAddressExUI>(shared_from_this());
