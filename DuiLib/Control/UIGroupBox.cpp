...
std::shared_ptr<CControlUI> CGroupBoxUI::GetInterface(faw::string_t pstrName)
{
    if(pstrName == _T("GroupBox")) return std::dynamic_pointer_cast<CGroupBoxUI>(shared_from_this());
