...
public:
    using ptr = std::shared_ptr<CButtonUI>;
    ...
    // 调整像素亮度的函数
    void adjustBrightness(DWORD& dwPixel, float alpha);
    void SetBtnBkColor(DWORD dwBackColor);
    ...
    void PaintBkSingleColor(HDC hDC,DWORD bkcolor, SIZE cBorderRound);
